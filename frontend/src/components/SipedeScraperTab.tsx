...
export default function SipedeScraperTab() {
    ...
    // Refresh - Deteksi ulang tabel (untuk ganti tahun)
    const handleRefreshTable = async () => {
        ...
        try {
            ...
            if (result.success) {
                ...
                setError(result.message || 'No table found. Pastikan Anda sudah memilih tahun dan berada di halaman data.');
            }
        } catch (err) {
    ...
    // Kembali ke pilih data (untuk ganti tahun)
    ...
    return (
        <div className="scraper-tab">
            <div className="tab-header">
                ...
                <p>Scraping data dari sistem SIPEDE Kejaksaan</p>
                {status?.browserOpen && (
            ...
            <div className="main-content">
                ...
                {step === 'initial' && (
                    <div className="card main-card">
                        ...
                        <p>Klik tombol di bawah untuk membuka browser SIPEDE</p>
                ...
                {step === 'browser-open' && (
                    <div className="card main-card">
                        ...
                        <p>Di browser SIPEDE yang terbuka:</p>
                        <ol className="instruction-list">
                            <li>Login dengan username dan password Anda</li>
                            <li>Selesaikan CAPTCHA</li>
                            <li><strong>Pilih tahun</strong> dari dropdown filter</li>
                            <li>Buka halaman data yang ingin di-scrape</li>
                        ...
                        <button onClick={handleDetectTable} className="primary-btn" disabled={isLoading}>
                            {isLoading ? (
                ...
                {step === 'ready' && tableInfo && (
                    <div className="card main-card">
                        ...
                        <h2>Data Terdeteksi!</h2>

                        {tableInfo.yearFilter && (
                            <div className="year-badge">
                                <span>Tahun: <strong>{tableInfo.yearFilter.selectedYear}</strong></span>
                            </div>
                        )}
                        ...
                        <div className="action-row">
                            <button onClick={handleChangeYear} className="secondary-btn" disabled={isLoading}>
                                🔄 Ganti Tahun
                            </button>
                        ...
                        <div className="info-box">
                            💡 <strong>Tip:</strong> Jika Anda mengganti tahun di website SIPEDE, klik "Ganti Tahun" atau "Refresh Data" untuk memperbarui informasi.
                        </div>
                    </div>
                )}
